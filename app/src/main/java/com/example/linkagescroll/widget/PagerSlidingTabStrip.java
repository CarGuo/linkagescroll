...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = getContext().getResources().getColor(R.color.style_color_main);
    private int underlineColor = 0x3A000000;
    ...
    private boolean isOpposite;//是否显示相反方向
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setBackgroundColor(Color.TRANSPARENT);
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                if (i == position) {
                    ...
                    addIconTab(i, ((IconTabProvider) pager.getAdapter()).getUnselectPageIconResId(i));
                }
            } else {
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            invalidate();
            if (!isOpposite) {
                setChooseTab(currentPosition);
            } else {
                setChooseTab((tabCount - 1) - currentPosition);
            }
